...
execute if entity @e[scores={DarkAquaBush=100..}] run replaceitem block 18 61 894 container.13 dead_bush{display:{Name:"{\"text\":\"Excalibush\",\"italic\":\"false\",\"color\":\"dark_aqua\"}",Lore:["This legendary Bush was given to a guy by an","old lady from some water. Then in 1963, the","guy had a cartoon made, where he told eveyone","he grabbed it from a rock to become some king."]},Enchantments:[{id:"minecraft:lure",lvl:10}],DarkAquaBush:1b,ShecretBush:1b} 1
...
execute if entity @e[scores={DarkPurpleBush=100..}] run replaceitem block 129 49 840 container.13 dead_bush{display:{Name:"{\"text\":\"Bushnir\",\"italic\":\"false\",\"color\":\"dark_purple\"}",Lore:["Once weilded by a god, when thrown, this","mystical Bush would boomerang back, and","could even attach cool posters to his","bedroom walls or fix broken chairs."]},Enchantments:[{id:"minecraft:lure",lvl:10}],DarkPurpleBush:1b,ShecretBush:1b} 1
...
execute if entity @e[scores={RedBush=100..}] run replaceitem block 109 67 1053 container.13 dead_bush{display:{Name:"{\"text\":\"Hidden Bush\",\"italic\":\"false\",\"color\":\"red\"}",Lore:["This concealed Assassin's wrist-Bush first","required amputation of the ring finger, until","the 13th century, when the it was altered so","that all fingers would be removed instead."]},Enchantments:[{id:"minecraft:lure",lvl:10}],RedBush:1b,ShecretBush:1b} 1
