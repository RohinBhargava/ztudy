...
execute align x align y align z as @a[x=0,y=86,z=1033,dx=16,dy=4,dz=5] at @s unless entity @s[x=3,y=90,z=1033,dx=3,dy=1,dz=4] run teleport @s ~ 91.2 ~1
...
fill -24 86 986 -24 86 986 hopper{CustomName:"{\"text\":\"Phantom Gondola Feeding Chute\"}"} replace grass_block
