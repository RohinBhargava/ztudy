...
# FEBRUARY 19 2018 / APRIL 20 2019
...
execute if block -966 88 998 oak_button[powered=true] run summon item -966 89 999 {Item:{id:"minecraft:water_bucket",Count:1,tag:{CanPlaceOn:["minecraft:gravel","minecraft:prismarine_brick_slab","minecraft:barrier"],display:{Name:"{\"italic\":false,\"color\":\"aqua\",\"text\":\"Gravel Bucket\"}",Lore:["Seems to only work on gravel.","As if that's realistic..."]}}}}
