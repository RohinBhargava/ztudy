...
# FEBRUARY 18 2018 / MARCH 30 2019
...
# OUT OF CELL -> LEVEL 1
execute align x align y align z run execute at @a[x=-989,y=1,z=805,dx=1,dy=3,dz=6] run scoreboard players set @e[scores={EscapeLevel=0}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-989,y=1,z=805,dx=1,dy=3,dz=6] run scoreboard players set @e[scores={EscapeLevel=0}] EscapeLevel 1
...
execute if entity @e[scores={EscapeLevel=1,EscapeTimer=20}] run execute at @e[tag=EscapeCFG_Jail] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @e[scores={EscapeLevel=1,EscapeTimer=20}] run execute at @e[tag=EscapeCFG_Jail] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
...
execute align x align y align z run execute at @a[x=-994,y=9,z=811,dx=4,dy=3,dz=4] run scoreboard players set @e[scores={EscapeLevel=..1}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-994,y=9,z=811,dx=4,dy=3,dz=4] run scoreboard players set @e[scores={EscapeLevel=..1}] EscapeLevel 2
...
execute if entity @e[scores={EscapeLevel=2,EscapeTimer=150}] run execute at @e[tag=EscapeCFG] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @e[scores={EscapeLevel=2,EscapeTimer=150}] run execute at @e[tag=EscapeCFG] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
...
execute align x align y align z run execute if entity @a[x=-1012,y=12,z=988,dx=16,dy=51,dz=16] run scoreboard players set @e[tag=MainEscapeAEC] Trial_1 1
...
execute align x align y align z run execute at @a[x=-1004,y=12,z=997,dx=8,dy=3,dz=0] run scoreboard players set @e[scores={EscapeLevel=..2}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-1004,y=12,z=997,dx=8,dy=3,dz=0] run scoreboard players set @e[scores={EscapeLevel=..2}] EscapeLevel 3
...
execute if entity @a[x=-1004,y=31,z=999,dx=0,dy=1,dz=0] run execute at @e[tag=EscapeCFG_Pillar] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @a[x=-1004,y=31,z=999,dx=0,dy=1,dz=0] run execute at @e[tag=EscapeCFG_Pillar] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
execute if entity @a[x=-1004,y=31,z=999,dx=0,dy=1,dz=0] run kill @e[tag=EscapeCFG_Pillar]

execute if entity @a[x=-998,y=38,z=996,dx=0,dy=1,dz=0] run execute at @e[tag=EscapeCFG_Corner] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @a[x=-998,y=38,z=996,dx=0,dy=1,dz=0] run execute at @e[tag=EscapeCFG_Corner] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
execute if entity @a[x=-998,y=38,z=996,dx=0,dy=1,dz=0] run kill @e[tag=EscapeCFG_Corner]

execute if block -1008 62 994 lever[powered=false] run execute at @e[tag=EscapeCFG_Dancing] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if block -1008 62 994 lever[powered=false] run execute at @e[tag=EscapeCFG_Dancing] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
...
# LIVING ROOM -> LEVEL 4
execute align x align y align z run execute at @a[x=-988,y=66,z=1009,dx=0,dy=0,dz=0] run scoreboard players set @e[scores={EscapeLevel=..3}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-988,y=66,z=1009,dx=0,dy=0,dz=0] run scoreboard players set @e[scores={EscapeLevel=..3}] EscapeLevel 4
...
execute if entity @e[scores={EscapeLevel=4,EscapeTimer=200}] run execute at @e[tag=EscapeCFG_TV] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @e[scores={EscapeLevel=4,EscapeTimer=200}] run execute at @e[tag=EscapeCFG_TV] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
...
execute align x align y align z run execute if entity @a[x=-1027,y=67,z=996,dx=31,dy=51,dz=40] run scoreboard players set @e[tag=MainEscapeAEC] Trial_2 1
...
execute align x align y align z run execute at @a[x=-997,y=67,z=1004,dx=0,dy=1,dz=0] run scoreboard players set @e[scores={EscapeLevel=..4}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-997,y=67,z=1004,dx=0,dy=1,dz=0] run scoreboard players set @e[scores={EscapeLevel=..4}] EscapeLevel 5
...
execute if entity @e[scores={EscapeLevel=5,EscapeTimer=1}] run execute at @e[tag=EscapeCFG_TV] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @e[scores={EscapeLevel=5,EscapeTimer=1}] run execute at @e[tag=EscapeCFG_TV] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
...
execute if entity @a[x=-1004,y=77,z=1023,dx=4,dy=1,dz=2] run execute at @e[tag=EscapeCFG_Balancing] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @a[x=-1004,y=77,z=1023,dx=4,dy=1,dz=2] run execute at @e[tag=EscapeCFG_Balancing] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
...
execute align x align y align z run execute at @a[x=-1027,y=89,z=995,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..5}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-1027,y=89,z=995,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..5}] EscapeLevel 6
...
execute if entity @a[x=-1047,y=89,z=972,dx=0,dy=2,dz=2] run execute at @e[tag=EscapeCFG_Ladder] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @a[x=-1047,y=89,z=972,dx=0,dy=2,dz=2] run execute at @e[tag=EscapeCFG_Ladder] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
execute if entity @a[x=-1047,y=89,z=972,dx=0,dy=2,dz=2] run kill @e[tag=EscapeCFG_Ladder]



# DIVERSE FOYER DOWNSTAIRS -> LEVEL 7
execute align x align y align z run execute at @a[x=-1047,y=89,z=972,dx=0,dy=2,dz=2] run scoreboard players set @e[scores={EscapeLevel=..6}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-1047,y=89,z=972,dx=0,dy=2,dz=2] run scoreboard players set @e[scores={EscapeLevel=..6}] EscapeLevel 7
...
execute align x align y align z run execute at @a[x=-1049,y=98,z=975,dx=0,dy=1,dz=0] run scoreboard players set @e[scores={EscapeLevel=..7}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-1049,y=98,z=975,dx=0,dy=1,dz=0] run scoreboard players set @e[scores={EscapeLevel=..7}] EscapeLevel 8
...
execute if entity @e[scores={EscapeLevel=8,EscapeTimer=200}] run execute at @e[tag=EscapeCFG_Fence] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @e[scores={EscapeLevel=8,EscapeTimer=200}] run execute at @e[tag=EscapeCFG_Fence] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
execute if entity @e[scores={EscapeLevel=8,EscapeTimer=200}] run kill @e[tag=EscapeCFG_Fence]

execute if entity @a[x=-1055,y=104,z=971,dx=0,dy=2,dz=4] run execute at @e[tag=EscapeCFG_Fence] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @a[x=-1055,y=104,z=971,dx=0,dy=2,dz=4] run execute at @e[tag=EscapeCFG_Fence] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
execute if entity @a[x=-1055,y=104,z=971,dx=0,dy=2,dz=4] run kill @e[tag=EscapeCFG_Fence]

execute if entity @e[scores={EscapeLevel=..8}] run execute as @e[tag=KnockbackCreeper] run kill @s
...
execute align x align y align z run execute if entity @a[x=-1018,y=95,z=953,dx=32,dy=4,dz=34] run scoreboard players set @e[tag=MainEscapeAEC] Trial_3 1
...
execute align x align y align z run execute at @a[x=-1016,y=97,z=972,dx=0,dy=2,dz=2] run scoreboard players set @e[scores={EscapeLevel=..8}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-1016,y=97,z=972,dx=0,dy=2,dz=2] run scoreboard players set @e[scores={EscapeLevel=..8}] EscapeLevel 9
...
# LIBRARY -> LEVEL 11
execute align x align y align z run execute at @a[x=-992,y=98,z=988,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..10}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-992,y=98,z=988,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..10}] EscapeLevel 11
...
execute if entity @a[x=-988,y=98,z=988,dx=0,dy=2,dz=0] run execute at @e[tag=EscapeCFG_Book] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @a[x=-988,y=98,z=988,dx=0,dy=2,dz=0] run execute at @e[tag=EscapeCFG_Book] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
execute if entity @a[x=-988,y=98,z=988,dx=0,dy=2,dz=0] run kill @e[tag=EscapeCFG_Book]

execute if entity @a[x=-994,y=94,z=991,dx=0,dy=1,dz=0] run execute at @e[tag=EscapeCFG_Grass] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @a[x=-994,y=94,z=991,dx=0,dy=1,dz=0] run execute at @e[tag=EscapeCFG_Grass] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
execute if entity @a[x=-994,y=94,z=991,dx=0,dy=1,dz=0] run kill @e[tag=EscapeCFG_Grass]

execute if entity @a[x=-987,y=88,z=990,dx=0,dy=2,dz=2] run execute at @e[tag=EscapeCFG_Grass] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute if entity @a[x=-987,y=88,z=990,dx=0,dy=2,dz=2] run execute at @e[tag=EscapeCFG_Grass] run particle portal ~ ~1 ~ 0.2 0.2 0.2 0.5 20 force @a
...
execute align x align y align z run execute if entity @a[x=-984,y=86,z=984,dx=21,dy=20,dz=43] run scoreboard players set @e[tag=MainEscapeAEC] Trial_4 1
...
execute align x align y align z run execute at @a[x=-977,y=88,z=1001,dx=0,dy=2,dz=2] run scoreboard players set @e[scores={EscapeLevel=..11}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-977,y=88,z=1001,dx=0,dy=2,dz=2] run scoreboard players set @e[scores={EscapeLevel=..11}] EscapeLevel 12
...
execute align x align y align z run execute at @a[x=-968,y=100,z=1023,dx=2,dy=-2,dz=2] run scoreboard players set @e[scores={EscapeLevel=..12}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-968,y=100,z=1023,dx=2,dy=-2,dz=2] run scoreboard players set @e[scores={EscapeLevel=..12}] EscapeLevel 13
...
execute align x align y align z run execute at @a[x=-968,y=90,z=1028,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..13}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-968,y=90,z=1028,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..13}] EscapeLevel 14
...
execute if entity @e[scores={EscapeLevel=14,EscapeTimer=180}] run execute at @e[tag=EscapeCFG_Cooking] run particle portal ~ ~0.5 ~ 0.2 0.2 0.2 1 50 force @a
execute if entity @e[scores={EscapeLevel=14,EscapeTimer=180}] run execute at @e[tag=EscapeCFG_Cooking] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
...
execute align x align y align z run execute if entity @a[x=-994,y=102,z=1029,dx=15,dy=5,dz=6] run scoreboard players set @e[tag=MainEscapeAEC] Trial_5 1
execute align x align y align z run execute if entity @a[x=-993,y=107,z=1007,dx=4,dy=6,dz=4] run scoreboard players set @e[tag=MainEscapeAEC] Trial_5 1
execute align x align y align z run execute if entity @a[x=-1010,y=106,z=954,dx=21,dy=14,dz=24] run scoreboard players set @e[tag=MainEscapeAEC] Trial_5 1
...
execute align x align y align z run execute at @a[x=-980,y=103,z=1031,dx=0,dy=3,dz=2] run scoreboard players set @e[scores={EscapeLevel=..14}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-980,y=103,z=1031,dx=0,dy=3,dz=2] run scoreboard players set @e[scores={EscapeLevel=..14}] EscapeLevel 15
...
execute align x align y align z run execute at @a[x=-992,y=102,z=1013,dx=2,dy=3,dz=0] run scoreboard players set @e[scores={EscapeLevel=..15}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-992,y=102,z=1013,dx=2,dy=3,dz=0] run scoreboard players set @e[scores={EscapeLevel=..15}] EscapeLevel 16
...
execute if block -991 101 1007 lever[powered=true] run execute if block -991 99 1005 iron_bars run playsound entity.experience_orb.pickup master @a -991 99 1005
execute if block -991 101 1007 lever[powered=true] run execute if block -991 99 1005 iron_bars run playsound item.chorus_fruit.teleport master @a -991 99 1005 1 0.7 0
execute if block -991 101 1007 lever[powered=true] run execute if block -991 99 1005 iron_bars run particle cloud -991 99 1005 1 1 0 0 100
...
execute align x align y align z run execute at @a[x=-992,y=111,z=1005,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..16}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-992,y=111,z=1005,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..16}] EscapeLevel 17



# TRIAL 5 - TIMEBOMB -> LEVEL 18
execute align x align y align z run execute at @a[x=-991,y=111,z=976,dx=0,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..17}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-991,y=111,z=976,dx=0,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..17}] EscapeLevel 18
...
execute if entity @e[scores={EscapeLevel=18,EscapeTimer=80}] run execute at @e[tag=EscapeCFG_Bomb] run particle portal ~ ~0.5 ~ 0.2 0.2 0.2 1 50 force @a
execute if entity @e[scores={EscapeLevel=18,EscapeTimer=80}] run execute at @e[tag=EscapeCFG_Bomb] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
...
execute align x align y align z run execute at @a[x=-1037,y=111,z=941,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..19}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-1037,y=111,z=941,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..19}] EscapeLevel 20
...
execute if entity @e[scores={EscapeLevel=20,EscapeTimer=180}] run execute at @e[tag=EscapeCFG_Bed] run particle portal ~ ~0.5 ~ 0.2 0.2 0.2 1 50 force @a
execute if entity @e[scores={EscapeLevel=20,EscapeTimer=180}] run execute at @e[tag=EscapeCFG_Bed] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
...
execute align x align y align z run execute if entity @a[x=-1041,y=117,z=942,dx=61,dy=31,dz=84] run scoreboard players set @e[tag=MainEscapeAEC] Trial_6 1
execute align x align y align z run execute if entity @a[x=-1019,y=143,z=946,dx=65,dy=32,dz=65] run scoreboard players set @e[tag=MainEscapeAEC] Trial_6 1
...
execute align x align y align z run execute at @a[x=-1037,y=120,z=942,dx=2,dy=3,dz=0] run scoreboard players set @e[scores={EscapeLevel=..20}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-1037,y=120,z=942,dx=2,dy=3,dz=0] run scoreboard players set @e[scores={EscapeLevel=..20}] EscapeLevel 21
...
execute if entity @e[scores={ArrowTimer=1}] run execute align x align y align z run execute at @a[x=-992,y=121,z=1008,dx=2,dy=18,dz=2] run summon arrow ~ 147 ~
...
execute align x align y align z run execute at @a[x=-988,y=143,z=1008,dx=0,dy=3,dz=2] run scoreboard players set @e[scores={EscapeLevel=..22}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-988,y=143,z=1008,dx=0,dy=3,dz=2] run scoreboard players set @e[scores={EscapeLevel=..22}] EscapeLevel 23
...
execute align x align y align z run execute at @a[x=-985,y=143,z=951,dx=4,dy=5,dz=0] run execute at @e[tag=EscapeCFG_Torches] run particle portal ~ ~0.5 ~ 0.2 0.2 0.2 1 50 force @a
execute align x align y align z run execute at @a[x=-985,y=143,z=951,dx=4,dy=5,dz=0] run execute at @e[tag=EscapeCFG_Torches] run playsound entity.enderman.teleport master @a ~ ~ ~ 0.5 1 0
execute align x align y align z run execute at @a[x=-985,y=143,z=951,dx=4,dy=5,dz=0] run kill @e[tag=EscapeCFG_Torches]

execute align x align y align z run execute at @a[x=-1006,y=143,z=949,dx=0,dy=3,dz=2] run scoreboard players set @e[scores={EscapeLevel=..24}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-1006,y=143,z=949,dx=0,dy=3,dz=2] run scoreboard players set @e[scores={EscapeLevel=..24}] EscapeLevel 25



# LAVA RISE -> LEVEL 26
execute align x align y align z run execute at @a[x=-1012,y=143,z=949,dx=0,dy=3,dz=2] run scoreboard players set @e[scores={EscapeLevel=..25}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-1012,y=143,z=949,dx=0,dy=3,dz=2] run scoreboard players set @e[scores={EscapeLevel=..25}] EscapeLevel 26
...
# TO DO ROOM -> LEVEL 27
execute align x align y align z run execute at @a[x=-1001,y=169,z=995,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..26}] EscapeTimer 0
execute align x align y align z run execute at @a[x=-1001,y=169,z=995,dx=2,dy=2,dz=0] run scoreboard players set @e[scores={EscapeLevel=..26}] EscapeLevel 27

#execute if entity @e[scores={EscapeLevel=27,EscapeTimer=1}] run kill @e[tag=ToDoArt]

execute if entity @e[scores={EscapeLevel=26..27,EscapeTimer=1}] run execute unless entity @e[tag=ToDoArt1] run summon item_frame -998 169 998 {Invulnerable:true,Facing:4b,Rotation:[90.0f,0.0f],Item:{id:"minecraft:anvil",Count:1b},Tags:["ToDoArt","ToDoArt1"]}
execute if entity @e[scores={EscapeLevel=26..27,EscapeTimer=1}] run execute unless entity @e[tag=ToDoArt2] run summon item_frame -998 169 999 {Invulnerable:true,Facing:4b,Rotation:[90.0f,0.0f],Item:{id:"minecraft:anvil",Count:1b},Tags:["ToDoArt","ToDoArt2"]}
execute if entity @e[scores={EscapeLevel=26..27,EscapeTimer=1}] run execute unless entity @e[tag=ToDoArt3] run summon item_frame -998 169 1001 {Invulnerable:true,Facing:4b,Rotation:[90.0f,0.0f],Item:{id:"minecraft:anvil",Count:1b},Tags:["ToDoArt","ToDoArt3"]}
execute if entity @e[scores={EscapeLevel=26..27,EscapeTimer=1}] run execute unless entity @e[tag=ToDoArt4] run summon item_frame -998 169 1002 {Invulnerable:true,Facing:4b,Rotation:[90.0f,0.0f],Item:{id:"minecraft:anvil",Count:1b},Tags:["ToDoArt","ToDoArt4"]}

execute if entity @e[scores={EscapeLevel=26..27,EscapeTimer=1}] run execute unless entity @e[tag=ToDoArt5] run summon item_frame -998 170 998 {Invulnerable:true,Facing:4b,Rotation:[90.0f,0.0f],Item:{id:"minecraft:anvil",Count:1b},Tags:["ToDoArt","ToDoArt5"]}
execute if entity @e[scores={EscapeLevel=26..27,EscapeTimer=1}] run execute unless entity @e[tag=ToDoArt6] run summon item_frame -998 170 999 {Invulnerable:true,Facing:4b,Rotation:[90.0f,0.0f],Item:{id:"minecraft:anvil",Count:1b},Tags:["ToDoArt","ToDoArt6"]}
execute if entity @e[scores={EscapeLevel=26..27,EscapeTimer=1}] run execute unless entity @e[tag=ToDoArt7] run summon item_frame -998 170 1001 {Invulnerable:true,Facing:4b,Rotation:[90.0f,0.0f],Item:{id:"minecraft:anvil",Count:1b},Tags:["ToDoArt","ToDoArt7"]}
execute if entity @e[scores={EscapeLevel=26..27,EscapeTimer=1}] run execute unless entity @e[tag=ToDoArt8] run summon item_frame -998 170 1002 {Invulnerable:true,Facing:4b,Rotation:[90.0f,0.0f],Item:{id:"minecraft:anvil",Count:1b},Tags:["ToDoArt","ToDoArt8"]}
...
execute if entity @e[scores={EscapeLevel=..27}] run execute align x align y align z run kill @e[type=item,x=-1003,y=192,z=997,dx=6,dy=6,dz=6]



# FINAL ROOM - CHECK FOR ALL PLAYERS -> LEVEL 28 
execute align x align y align z run execute as @a[x=-1003,y=192,z=997,dx=6,dy=6,dz=6] run scoreboard objectives add FinalBox dummy
...
execute align x align y align z run execute as @a[x=-1003,y=192,z=997,dx=6,dy=6,dz=6] run scoreboard players remove @e[tag=MainEscapeAEC] FinalBox 1
...
execute if entity @e[scores={EscapeLevel=28,EscapeTimer=20..}] run execute as @a[tag=Climber] at @s run teleport @s ~ 192.1 ~
execute if entity @e[scores={EscapeLevel=28,EscapeTimer=20..}] run teleport @a[tag=!Climber,tag=OutsideBox] -1000 192 997 0 0
...
execute if entity @e[scores={EscapeLevel=..27,EscapeTimer=1}] run execute align x align y align z run kill @e[tag=MileyCyrus,x=-1003,y=192,z=997,dx=6,dy=6,dz=6]
...
execute if entity @e[scores={EscapeLevel=28,EscapeTimer=800}] run execute at @e[tag=EscapeCFG] run playsound block.wool.step master @a ~ ~ ~ 1 1.3 0
...
execute if entity @e[scores={EscapeLevel=28,EscapeTimer=900}] run execute at @e[tag=EscapeCFG] run playsound block.wool.step master @a ~ ~ ~ 1 1.3 0
...
execute if entity @e[scores={EscapeLevel=28,EscapeTimer=1001}] run execute as @e[tag=MileyCyrus] run data merge entity @s {NoAI:false}
execute if entity @e[scores={EscapeLevel=28,EscapeTimer=1001}] run execute as @e[tag=MileyCyrus] at @s run teleport @s ~ ~-300 ~
...
execute align x align y align z run execute if entity @e[tag=MileyCyrus,x=-1002,y=192,z=1002,dx=0,dy=0,dz=0] run fill -1002 192 1003 -1002 194 1003 air destroy

execute if entity @e[scores={EscapeLevel=28,EscapeTimer=..1400}] run execute as @e[tag=MileyCyrus,x=-1004,y=192,z=1002,dx=3,dy=0,dz=0] at @s run teleport @s ~0.4 ~ ~
...
execute if entity @e[scores={EscapeLevel=28,EscapeTimer=..1400}] run execute align x align y align z run execute as @e[tag=MileyCyrus,x=-1000,y=192,z=1002,dx=0,dy=0,dz=0] at @s run teleport @s -1000 192 1002
...
execute as @e[tag=MileyCyrus,x=-1000,y=192,z=1002,dx=0,dy=0,dz=0] run execute as @e[tag=EscapeCFG_Final,x=-1000,y=192,z=1002,dx=0,dy=0,dz=0] run execute at @a run playsound entity.player.attack.knockback master @a ~ ~ ~ 1 1 1
execute as @e[tag=MileyCyrus,x=-1000,y=192,z=1002,dx=0,dy=0,dz=0] run execute as @e[tag=EscapeCFG_Final,x=-1000,y=192,z=1002,dx=0,dy=0,dz=0] run execute at @a run playsound entity.vindication_illager.hurt master @a ~ ~ ~ 1 1 0
...
execute if entity @e[scores={EscapeLevel=28,EscapeTimer=1430..1600}] run execute as @e[tag=MileyCyrus,x=-1000,y=192,z=1002,dx=0,dy=0,dz=0] at @s run teleport @s -1000 192 ~0.03 180 30
