...
# SEPTEMBER 13 2017 / APRIL 18 2019
...
scoreboard objectives add DropDeaths deathCount {"text":"Broken Bones","color":"dark_red","bold":"true","underlined":"true"}
...
tellraw @a[scores={LightBlueTravel=3,DropSpeech=1}] ["",{"text":"<texelelf> ","color":"dark_aqua","bold":false},{"text":"Pefect! You managed to infiltrate the enemy aircraft too! I'll let you have the honors!","color":"none","bold":false,"underlined":false}]
