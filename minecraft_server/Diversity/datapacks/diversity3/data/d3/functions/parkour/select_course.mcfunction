...
execute if entity @e[scores={ParkourTimer=400}] run summon area_effect_cloud 1000 67.7 -1000 {CustomName:"{\"text\":\"Click to Select Course\",\"color\":\"red\"}",CustomNameVisible:true,Tags:["ClickSelect"],Duration:2147483647}
