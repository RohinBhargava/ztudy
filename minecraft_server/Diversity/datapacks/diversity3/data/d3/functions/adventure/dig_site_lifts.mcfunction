...
# NOVEMBER 10 2018 / MARCH 21 2019
...
# FALLING BLOCKS
execute unless entity @e[tag=BlockLiftA] run summon armor_stand 931 115 2078 {Invisible:true,Invulnerable:1b,NoGravity:true,Small:true,Marker:true,Tags:["BlockLift","BlockLiftAS","BlockLiftA","BlockLiftAAS"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:black_concrete_powder"},Tags:["BlockLift","BlockLiftFB","BlockLiftA","BlockLiftAFB"],NoGravity:true,DropItem:false,Time:-2147483648}],DisabledSlots:2039583}

execute unless entity @e[tag=BlockLiftB] run summon armor_stand 923 115 2078 {Invisible:true,Invulnerable:1b,NoGravity:true,Small:true,Marker:true,Tags:["BlockLift","BlockLiftAS","BlockLiftB","BlockLiftBAS"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:black_concrete_powder"},Tags:["BlockLift","BlockLiftFB","BlockLiftB","BlockLiftBFB"],NoGravity:true,DropItem:false,Time:-2147483648}],DisabledSlots:2039583}
