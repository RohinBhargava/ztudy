...
execute if entity @e[scores={AdventureLevel=27,AdventureTimer=250}] run tellraw @a ["",{"text":"<Ockels> ","color":"dark_green","bold":false},{"text":"Shut up Farkas. Or do you want me tell the whole place how you peed your pants because you didn't have a nightlight during the power outage?","color":"none","bold":false,"underlined":false}]
