...
execute unless entity @e[tag=ShulkerVator7] run summon armor_stand 995 92 1971 {Invisible:true,NoGravity:true,Small:true,Marker:true,Tags:["ShulkerVator","ShulkerVatorAS","ShulkerVator7","ShulkerVator7AS"],Passengers:[{id:"minecraft:shulker",Tags:["ShulkerVator","ShulkerVatorMob","ShulkerVator7","ShulkerVator7Mob"],NoAI:true,Silent:true}],DisabledSlots:2039583}
execute unless entity @e[tag=ShulkerVator8] run summon armor_stand 995 92 1970 {Invisible:true,NoGravity:true,Small:true,Marker:true,Tags:["ShulkerVator","ShulkerVatorAS","ShulkerVator8","ShulkerVator8AS"],Passengers:[{id:"minecraft:shulker",Tags:["ShulkerVator","ShulkerVatorMob","ShulkerVator8","ShulkerVator8Mob"],NoAI:true,Silent:true}],DisabledSlots:2039583}
execute unless entity @e[tag=ShulkerVator9] run summon armor_stand 995 92 1969 {Invisible:true,NoGravity:true,Small:true,Marker:true,Tags:["ShulkerVator","ShulkerVatorAS","ShulkerVator9","ShulkerVator9AS"],Passengers:[{id:"minecraft:shulker",Tags:["ShulkerVator","ShulkerVatorMob","ShulkerVator9","ShulkerVator9Mob"],NoAI:true,Silent:true}],DisabledSlots:2039583}
