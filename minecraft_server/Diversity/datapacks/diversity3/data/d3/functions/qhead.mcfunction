...
execute if entity @e[scores={qHeadTimer=1030}] run summon item 10.2 251 999.9 {Item:{id:"minecraft:blue_wool",Count:1b},Age:-32768,PickupDelay:32767,NoGravity:true,Tags:["qHeadWool"]}
...
execute if entity @e[scores={qHeadTimer=1030}] run summon item 10.2 251 998.1 {Item:{id:"minecraft:red_wool",Count:1b},Age:-32768,PickupDelay:32767,NoGravity:true,Tags:["qHeadWool"]}
