...
execute align x align y align z as @a[x=-127,y=1,z=-127,dx=252,dy=200,dz=252] unless entity @s[x=0,y=1,z=-32,dx=15,dy=15,dz=2] if entity @s[gamemode=survival] run tellraw @s ["",{"text":"<qmagnet> ","color":"gold","bold":false},{"text":"You can thank Vilder50 for making me do this.","color":"none","bold":false,"underlined":false}]
execute align x align y align z as @a[x=-127,y=1,z=-127,dx=252,dy=200,dz=252] unless entity @s[x=0,y=1,z=-32,dx=15,dy=15,dz=2] run kill @s[gamemode=survival]
fill 0 1 -20 15 10 -20 barrier replace air
...
# ADVANCEMENTS
scoreboard objectives add SpawnerBroke dummy
