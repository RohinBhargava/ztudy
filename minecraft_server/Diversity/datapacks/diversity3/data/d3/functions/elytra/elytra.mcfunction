...
execute align x align y align z if entity @a[x=-1753,y=204,z=2047,dx=4,dy=4,dz=4] run function d3:elytra/set_player

execute align x align y align z as @a[x=-1802,y=208,z=2062,dx=4,dy=4,dz=-1] run function d3:elytra/reset_player
execute align x align y align z if entity @a[x=-1802,y=208,z=2063,dx=4,dy=4,dz=1] run function d3:elytra/set_player
...
execute align x align y align z if entity @a[x=-1853,y=209,z=2048,dx=4,dy=4,dz=4] run function d3:elytra/set_player

execute align x align y align z as @a[x=-1866,y=208,z=1998,dx=1,dy=4,dz=4] run function d3:elytra/reset_player
execute align x align y align z if entity @a[x=-1867,y=208,z=1998,dx=-1,dy=4,dz=4] run function d3:elytra/set_player
...
execute align x align y align z if entity @a[x=-1842,y=208,z=1945,dx=4,dy=4,dz=4] run function d3:elytra/set_player

execute align x align y align z as @a[x=-1802,y=208,z=1930,dx=4,dy=4,dz=1] run function d3:elytra/reset_player
execute align x align y align z if entity @a[x=-1802,y=208,z=1929,dx=4,dy=4,dz=-1] run function d3:elytra/set_player
...
execute align x align y align z if entity @a[x=-1747,y=208,z=1943,dx=4,dy=4,dz=4] run function d3:elytra/set_player

execute align x align y align z as @a[x=-1737,y=214,z=1996,dx=-1,dy=4,dz=4] run function d3:elytra/reset_player
execute align x align y align z if entity @a[x=-1736,y=214,z=1996,dx=1,dy=4,dz=4] run function d3:elytra/set_player
