...
execute if entity @e[scores={Incorrect_R8C=1}] run execute at @a run playsound item.totem.use master @a ~ ~ ~ 0.5 1 0
...
execute if entity @e[scores={Incorrect_R8C=1}] run setblock 922 62 1203 dispenser[facing=north]{CustomName: "{\"text\":\"Safe\"}", x: 922, y: 62, z: 1203, Items: [{Slot: 4b, id: "minecraft:golden_carrot", Count: 1b}]}
