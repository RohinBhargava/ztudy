...
# DECEMBER 30 2018 / MARCH 14 2019
...
execute if entity @e[tag=MainArenaAEC,tag=!CreeperNear,scores={CreeperTotal=19}] run tellraw @a ["",{"text":"<AdamDJM> ","color":"yellow"},{"text":"One more creeeper to go!","color":"none"}]
