...
# DECEMBER 30 2018 / MARCH 16 2019
...
execute if entity @e[scores={ArenaRound=1,ArenaTimer=480}] run tellraw @a ["",{"text":"<AdamDJM> ","color":"yellow"},{"text":"You may return to the Trade Shop at any time during the Round. You'll need it. Especially, that handy little spawner smashing tool...","color":"none"}]
