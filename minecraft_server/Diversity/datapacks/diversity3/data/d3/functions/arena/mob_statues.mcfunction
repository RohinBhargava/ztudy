...
execute if entity @e[scores={WSkeletonTotal=1..}] unless entity @e[tag=ArenaWitherSkeletonStatue] run summon wither_skeleton -29.5 47 1946.5 {NoAI:true,Invulnerable:true,Silent:true,PersistenceRequired:1b,Rotation:[270f,0f],Team:ArenaStatues,Tags:["ArenaMob","ArenaStatue","ArenaWitherSkeletonStatue"]}
...
execute if block 11 5 78 gold_block unless entity @e[tag=ArenaBoss3Statue] run summon illusioner -42 47 1949 {NoAI:0b,Invulnerable:1b,Silent:1b,PersistenceRequired:1b,Rotation:[270f,0f],Tags:["ArenaMob","ArenaBossStatue","ArenaBoss3Statue"],CustomName:"{\"text\":\"IllusioNeige\",\"color\":\"gold\"}",CustomNameVisible:true}
