...
execute if entity @e[scores={Boss3Attack=100}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[0.3d,0.3d,0.0d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}
execute if entity @e[scores={Boss3Attack=100}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[-0.3d,0.3d,0.0d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}
execute if entity @e[scores={Boss3Attack=100}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[0.0d,0.3d,0.3d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}
execute if entity @e[scores={Boss3Attack=100}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[0.0d,0.3d,-0.3d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}

execute if entity @e[scores={Boss3Attack=120}] at @e[tag=ArenaBoss3] run playsound entity.shulker.shoot hostile @a ~ ~ ~ 2 1 1
execute if entity @e[scores={Boss3Attack=120}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[0.5d,0.4d,0.3d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}
execute if entity @e[scores={Boss3Attack=120}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[-0.5d,0.4d,0.3d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}
execute if entity @e[scores={Boss3Attack=120}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[0.3d,0.4d,0.5d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}
execute if entity @e[scores={Boss3Attack=120}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[0.3d,0.4d,-0.5d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}

execute if entity @e[scores={Boss3Attack=140}] at @e[tag=ArenaBoss3] run playsound entity.shulker.shoot hostile @a ~ ~ ~ 2 1 1
execute if entity @e[scores={Boss3Attack=140}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[0.7d,0.5d,0.2d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}
execute if entity @e[scores={Boss3Attack=140}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[-0.7d,0.5d,0.2d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}
execute if entity @e[scores={Boss3Attack=140}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[0.2d,0.5d,0.7d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}
execute if entity @e[scores={Boss3Attack=140}] at @e[tag=ArenaBoss3] run summon endermite ~ ~ ~ {Motion:[0.2d,0.5d,-0.7d],Attributes:[{Name:"generic.movementSpeed",Base:0.30}],Invulnerable:1b,Tags:["ArenaMob","ArenaAlcoveMob","ArenaEndermite"]}
