...
execute if entity @e[tag=MainArenaAEC,tag=!WSkeletonNear,scores={WSkeletonTotal=24}] run tellraw @a ["",{"text":"<AdamDJM> ","color":"yellow"},{"text":"You only need one more wither skeleton kill!","color":"none"}]
...
execute if entity @e[tag=MainArenaAEC,tag=!WSkeletonDone,scores={WSkeletonTotal=25}] run tellraw @a ["",{"text":"<AdamDJM> ","color":"yellow"},{"text":"Finally! ","color":"none"},{"text":"25 wither skeletons are dust","color":"gold"},{"text":"! Get rid of that spawner!","color":"none"}]
...
execute if entity @e[scores={ArenaRound=3,ArenaTimer=2310}] run tellraw @a ["",{"text":"<AdamDJM> ","color":"yellow","bold":false},{"text":"You all know her as highly intelligent, beautiful first born daughter of qmagnet...","color":"none","bold":false,"underlined":false}]
