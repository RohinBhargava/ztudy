...
execute if entity @e[scores={Passivier=2}] at @e[tag=ArenaAlcoveMob,type=wither_skeleton] run summon donkey ~ ~ ~ {CustomName:"{\"text\":\"Wither Skeleton\",\"color\":\"gray\"}",CustomNameVisible:1b,Rotation:[270f,0f],Age:-9999999,Tags:["ArenaMob","ArenaWitherSkeleton","ArenaAlcoveMob","ArenaAlcove4Mob","Passive"]}
...
execute if entity @e[scores={Passivier=1200}] at @e[tag=Passive,tag=ArenaWitherSkeleton] run summon wither_skeleton ~ ~ ~ {Attributes:[{Name:"generic.followRange",Base:20.0},{Name:"generic.attackDamage",Base:1.5}],HandItems:[{id:"minecraft:stone_sword",Count:1b}],PersistenceRequired:1b,Rotation:[270f,0f],Team:ArenaMob,Tags:["ArenaMob","ArenaWitherSkeleton","ArenaAlcoveMob","ArenaAlcove4Mob"]}
