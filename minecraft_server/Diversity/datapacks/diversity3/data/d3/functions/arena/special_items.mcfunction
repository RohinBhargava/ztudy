...
execute if block -12 51 1964 light_gray_stained_glass unless entity @e[tag=ArenaWolf] run summon wolf -11.64 51.05 1964.5  {Invulnerable:1b,Silent:true,NoAI:true,Sitting:1b,Age:-9999999,Health:100.0f,Attributes:[{Name:"generic.maxHealth",Base:100.0},{Name:"generic.attackDamage",Base:5.0}],CollarColor:4b,Rotation:[270f,0f],Team:ArenaStatues,Tags:["ArenaWolf"]}
...
execute if entity @e[scores={ArenaRound=1..}] if block -12 51 1962 air if entity @e[tag=OrangeArenaStand] run summon item -12 51 1962 {Item:{id:"minecraft:egg",Count:1b,tag:{HideFlags:1,display:{Name:"{\"text\":\"Passivier\",\"italic\":\"false\",\"color\":\"gold\",\"bold\":\"true\"}",Lore:["*** ONE-TIME USE / LASTS 1 MINUTE ***","*** DOES NOT WORK ON BOSSES ***"," ","Throwing this will cause all present","enemies to tranform into domestic","animals"," ","Kills are still counted towards","the hostile totals"]},Enchantments:[{id:"minecraft:sharpness",lvl:2s}]}},Motion:[0.0d,0.2d,0.0d]}
...
effect give @a[tag=Dracula,scores={DraculaKill=1..}] regeneration 2 1 true
