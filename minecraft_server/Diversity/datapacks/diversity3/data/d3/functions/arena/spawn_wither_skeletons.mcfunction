...
execute if entity @e[scores={SpawnWSkeleton=20,ScanWSkeleton=..7}] at @e[tag=ArenaWitherSkeletonAEC] run summon wither_skeleton ~ ~ ~ {Attributes:[{Name:"generic.followRange",Base:40.0},{Name:"generic.attackDamage",Base:2.0}],HandItems:[{id:"minecraft:stone_sword",Count:1b}],PersistenceRequired:1b,Rotation:[270f,0f],Team:ArenaMob,Tags:["ArenaMob","ArenaWitherSkeleton","ArenaAlcoveMob","ArenaAlcove4Mob"]}
